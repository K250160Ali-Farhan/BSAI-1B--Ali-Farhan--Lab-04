...
int main()
{
    ...
    */
    ...
    // Apply scoop pricing and offers
    ...
    */
    ...
    // === Step 5 & 8: Sprinkles / Free topping ===
    /* Sprinkles cost $0.75, but if the user
       buys 3 scoops + waffle cone → free topping */
    char sprinkles;
